...
//daveti: debug
printf("daveti: got key for [0x%x] [%s]\n", ip_addr, pa_ntoa(earp->arp_tpa));
DEBUG_MSG("daveti: got key for [0x%x] [%s]", ip_addr, pa_ntoa(earp->arp_tpa));
...
//daveti: debug
printf("daveti: got NO key for [0x%x] [%s]\n", ip_addr, pa_ntoa(earp->arp_tpa));
DEBUG_MSG("daveti: got NO key for [0x%x] [%s]", ip_addr, pa_ntoa(earp->arp_tpa));
